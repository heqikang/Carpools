...
@property (nonatomic,copy) CGFloat (^heightForHeaderInSection)(GroupShadowTableView *tableView,NSInteger section);

@property (nonatomic,copy) CGFloat (^heightForFooterInSection)(GroupShadowTableView *tableView,NSInteger section);

-(void)scrollViewDidScroll:(GroupShadowTableView *)scrollView;
